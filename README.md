...
```
 Ninguno, esperancitos.
```

_Para CuadraticApp! [Web version]_

## Ejecutando las pruebas ⚙️

_Al dia de hoy se esta mejorando los estilos._

## Tecnologías usadas al momento. 📌
<!-- Python -->
|<a href="https://www.python.org/downloads/"><img align="center" alt="Pyhton" src="https://github.com/caidevOficial/Logos/blob/master/Lenguajes/logo-js.png" width="50px" height="50px" />|<h3>Javascript</h3>|
|--------|----------|
